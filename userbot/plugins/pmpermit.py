...
USER_BOT_WARN_ZERO = "`You were spamming my peru master's inbox, henceforth your retarded lame spammer has been blocked by my master's userbot.` "
USER_BOT_NO_WARN = ("[──▄█▀█▄─────────██ \n▄████████▄───▄▀█▄▄▄▄ \n██▀▼▼▼▼▼─▄▀──█▄▄ \n█████▄▲▲▲─▄▄▄▀───▀▄ \n██████▀▀▀▀─▀────────▀▀](tg://user?id=1263499813)\n\n"
                    "`Hello, this is Levithan Security Service.You have found your way here to my master,`"
                    f"{DEFAULTUSER}`'s inbox.\n\n"
                    "Leave your name, phone number, address and 999,999,999₹ and hopefully you'll get a reply within 2 light years.`\n\n"
